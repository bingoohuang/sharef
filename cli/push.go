...
func Push(args []string) {
	...
	daemonize := flagset.Bool("d", false, "- Daemonize Sender, you must kill it")
	keepsync := flag.Bool("f", false, "- Stream/Sync files")
