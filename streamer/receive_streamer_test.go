...
func TestReceiveStreamerNewStreamFrame(t *testing.T) {
	...
	t.Run("File", func(t *testing.T) {
		checkNewStreamFrameSingle(t, StreamFile{Name: "file.txt", SizeLen: int64(512), Mode: 0o644}, receiver, mocker)
	})

	t.Run("FileUnderDir", func(t *testing.T) {
		checkNewStreamFrameSingle(t, StreamFile{Name: "subdir/file.txt", SizeLen: int64(512), Mode: 0o644}, receiver, mocker)
	})
}
...
func TestReceiveStreamerStreamData(t *testing.T) {
	...
	sf := StreamFile{Name: "file.txt", SizeLen: int64(len(content)), Mode: 0o644}
