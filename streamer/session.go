...
const (
	SdpOfferPrompt  = "Send this offer:"
	SdpAnswerPrompt = "Send this answer:"
)

var ICEServerList = []webrtc.ICEServer{{
	URLs: []string{
...
func (s *Session) CreateAnswer() error {
	...
	return s.createSessionDescription(answer, SdpAnswerPrompt)
}
...
func (s *Session) CreateOffer() error {
	...
	return s.createSessionDescription(offer, SdpOfferPrompt)
}
